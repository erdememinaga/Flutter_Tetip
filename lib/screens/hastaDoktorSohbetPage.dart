...
class HastaDoktorSohbetPage extends StatefulWidget {
  User user;
  String seciliDoktorId, seciliSohbetId, sohbetName, sohbetUrl, userToken;
  HastaDoktorSohbetPage(
      {this.seciliDoktorId,
      this.user,
      this.seciliSohbetId,
      this.sohbetName,
      ...
      this.userToken});
  @override
  State<HastaDoktorSohbetPage> createState() => _HastaDoktorSohbetPageState();
}

class _HastaDoktorSohbetPageState extends State<HastaDoktorSohbetPage> {
  ...
  void _sendMessage(String mesaj) async {
    await _firebaseFirestore
        ...
        .doc(widget.seciliDoktorId)
        .collection("sohbetler")
        .doc(widget.seciliSohbetId)
        .collection("mesajlar")
        .add({"mesaj": mesaj, "gönderen": "hasta", "date": DateTime.now()});
  }
    ...
    await _firebaseFirestore
        ...
        .then((value) => {
              value.docs.forEach((element) {
                print("mesajjj" +
                    element.data()["mesaj"].toString() +
                    element.data()["date"].toString());
                if (element.data()["gönderen"] == "doktor") {
