...
class HastaProfileEdit extends StatefulWidget {
  User user;
  String name, surName;
  HastaProfileEdit({this.user, this.name, this.surName});
  @override
  _HastaProfileEditState createState() => _HastaProfileEditState();
}

class _HastaProfileEditState extends State<HastaProfileEdit> {
                ...
                children: [
                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      child: FlatButton(
                        onPressed: () async {
                          //bu kısımda hasta bilgileri güncelleme formundan alınan veriler
                          //firebasede gerekli yerlerde güncellenir.
