...
class HastaDoktorFirstSohbetPage extends StatefulWidget {
  User user;
  ...
  HastaDoktorFirstSohbetPage(
      ...
      this.userToken});
  @override
  State<HastaDoktorFirstSohbetPage> createState() =>
      _HastaDoktorFirstSohbetPageState();
}

class _HastaDoktorFirstSohbetPageState
    extends State<HastaDoktorFirstSohbetPage> {
